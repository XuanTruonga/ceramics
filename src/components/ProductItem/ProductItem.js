...
function ProductItem({ classImg = 'bg-pinkLight', data = {}, index }) {
  ...
  return (
    <div className='overflow-hidden max-w-[276px]'>
      <div className=' relative'>
        {/* img */}
        <div className='hover-input'>
          <Link to='/productCard'>
            <div className='overflow-hidden rounded-lg'>
              <div className='smooth-zoom'>
                <img
                  className={classImg}
                  src='//bizweb.dktcdn.net/thumb/large/100/485/241/products/untitled-2.png?v=1686285750047'></img>
              </div>
            </div>
              ...
              <div className=''>
                <div>
                  <button
                    ...
                    <div className='w-full h-full flex_center' onClick={() => HandleAddCart(data, setRenderApp.setRenderApp)}>
                      <CartIconFull />
                    </div>
                  </button>
                </div>
        ...
        <div className='p-y[10px]'>
          <div className='mb-[5px] mt-4 ml-1'>
            ...
            <span className='text-[15px] text-gray line-through ml-4 inline-block'>
              {data.discount !== '0' ? parseInt(data.priceRoot).toLocaleString() + 'đ' : null}
            </span>
          </div>
        </div>
      </div>
